...
public class FourBallTwoSteal extends SequentialCommandGroup {
  /** Creates a new FourBallTwoSteal. */
  public FourBallTwoSteal(DriveBase driveBase, Intake intake, Shooter shooter, Feeder feeder, Limelight limelight, Pigeon2Subsystem pigeon2Subsystem, Turret turret, double waitTime) {
    Trajectory trajectory1 = PathPlanner.loadPath("4Ball2StealPt1", 1.5, 2, false);
    Trajectory trajectory2 = PathPlanner.loadPath("4Ball2StealPt2", 1.5, 2, false);
    Trajectory trajectory3 = PathPlanner.loadPath("4Ball2StealPt2", 1.5, 2, false);
    Trajectory trajectory4 = PathPlanner.loadPath("4Ball2StealPt3", 1.5, 2, false);
